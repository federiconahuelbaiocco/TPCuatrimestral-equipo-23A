            ...
            <div class="card shadow-sm h-100">
                <div class="card-body d-flex flex-column justify-content-center">
                    ...
                    <div class="d-grid gap-3">
                        ...
                        <asp:HyperLink ID="hlConsultorios" runat="server" NavigateUrl="~/Consultorios.aspx" CssClass="btn btn-warning fw-semibold py-3">Gestionar Consultorios</asp:HyperLink>
                    </div>
                </div>
            </div>
        </div>
