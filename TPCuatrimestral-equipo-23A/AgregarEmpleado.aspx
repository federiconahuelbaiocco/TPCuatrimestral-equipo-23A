...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <i class="bi bi-briefcase"></i>
       Información Laboral
         ...
         <div class="row g-3">
          <div class="col-md-6">
          <label for="<%= txtLegajo.ClientID %>" class="form-label">Legajo / ID Empleado</label>
      <asp:TextBox ID="txtLegajo" runat="server" CssClass="form-control" placeholder="Ingrese el legajo"></asp:TextBox>
 </div>
 <div class="col-md-6">
...
<div class="form-section">
 ...
 Credenciales de Acceso
   ...
   <div class="row g-3">
 <div class="col-md-6">
 <label for="<%= txtEmailLogin.ClientID %>" class="form-label">Correo Electrónico (Login)</label>
     <asp:TextBox ID="txtEmailLogin" runat="server" CssClass="form-control" placeholder="ejemplo@clinic.com" TextMode="Email"></asp:TextBox>
       </div>
  <div class="col-md-6">
   ...
   <asp:TextBox ID="txtContrasena" runat="server" CssClass="form-control" placeholder="Crear una contraseña segura" TextMode="Password"></asp:TextBox>
    ...
    <div class="form-actions">
      ...
      <asp:Button runat="server" Text="Guardar Empleado" CssClass="btn-save" />
            </div>
        </div>
    </div>
</asp:Content>
