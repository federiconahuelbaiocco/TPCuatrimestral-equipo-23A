    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            <div class="input-group">
                ...
                <asp:TextBox ID="txtFiltro" AutoPostBack="true" OnTextChanged="Filtro_TextChanged" placeholder="Buscar paciente por nombre, apellido o DNI" CssClass="form-control" runat="server" />
