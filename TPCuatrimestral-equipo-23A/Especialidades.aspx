            ...
            <div class="mb-4 p-4 bg-white rounded shadow-sm border">
                ...
                <div class="row g-3 align-items-end">
                    <div class="col-sm">
                        ...
                        <asp:RequiredFieldValidator ID="rfvNombreEspecialidad" runat="server" ControlToValidate="txtNombreEspecialidad" ErrorMessage="Ingrese un nombre." CssClass="text-danger small fw-bold" Display="Dynamic" ValidationGroup="Agregar" />
                    </div>
                    <div class="col-sm-auto">
                        <asp:Button ID="btnAgregarEspecialidad" runat="server" Text="➕ Agregar" CssClass="btn btn-primary btn-lg fw-bold px-4" OnClick="btnAgregarEspecialidad_Click" ValidationGroup="Agregar" />
                    </div>
                </div>
            </div>
            ...
            <div id="formularioEdicion" class="sidebar-form-edit" style="display: none;">
                ...
                <div class="sidebar-actions">
                    <asp:Button ID="btnGuardarEdicion" runat="server" Text=" GUARDAR CAMBIOS"
                        CssClass="sidebar-btn-save w-100 mb-2"
