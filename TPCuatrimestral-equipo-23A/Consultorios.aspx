            ...
            <div class="mb-4 p-4 bg-white rounded shadow-sm border">
                ...
                <div class="row g-3 align-items-end">
                    <div class="col-sm position-relative">
                        ...
                        <asp:TextBox ID="txtNombreConsultorio" runat="server" CssClass="form-control form-control-lg" placeholder="Ej. Sala de Rayos X" ValidationGroup="Agregar"></asp:TextBox>

                        <div class="position-absolute start-0" style="top: 100%; width: 100%;">
                            <asp:RequiredFieldValidator ID="rfvNombreConsultorio" runat="server" ControlToValidate="txtNombreConsultorio" ErrorMessage="El nombre es requerido." CssClass="text-danger small fw-bold" Display="Dynamic" ValidationGroup="Agregar" />
                        </div>
                    </div>

                    <div class="col-sm-auto">
                        <asp:Button ID="btnAgregarConsultorio" runat="server" Text="➕ Agregar" CssClass="btn btn-primary btn-lg fw-bold px-4" OnClick="btnAgregarConsultorio_Click" ValidationGroup="Agregar" />
                    </div>
                </div>
            </div>
        ...
        <div class="sidebar-panel-body">
            ...
            <div id="formularioEdicion" class="sidebar-form-edit" style="display: none;">
                <div class="sidebar-form-group">
                    ...
                    <asp:TextBox ID="txtNombreEditar" runat="server" CssClass="sidebar-input" placeholder="Ej. Consultorio 1" ValidationGroup="Editar"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtNombreEditar" ErrorMessage="El nombre es requerido." CssClass="text-danger small fw-bold" Display="Dynamic" ValidationGroup="Editar" />
                </div>
                ...
                <div class="sidebar-actions">
                    <asp:Button ID="btnGuardarEdicion" runat="server" Text=" GUARDAR CAMBIOS" CssClass="sidebar-btn-save w-100 mb-2" OnClick="btnGuardarEdicion_Click" ValidationGroup="Editar" />
